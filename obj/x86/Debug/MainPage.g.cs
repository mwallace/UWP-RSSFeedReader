#pragma checksum "C:\Users\mryan\onedrive\documents\visual studio 2017\Projects\UWPTestApp\UWPTestApp\MainPage.xaml" "{406ea660-64cf-4c82-b6f0-42d48172a799}" "A44B38118A4054A89C076623A7282DED"
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace RSSFeedReader
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
        ...
        private class MainPage_obj5_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::RSSFeedReader.RSSLink dataRoot;
            ...
            public void ProcessBindings(global::System.Object item, int itemIndex, int phase, out int nextPhase)
            {
                ...
                this.Update_((global::RSSFeedReader.RSSLink) item, 1 << phase);
            }
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                ...
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::RSSFeedReader.RSSLink)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            private void Update_(global::RSSFeedReader.RSSLink obj, int phase)
            {
            ...
            private class MainPage_obj5_BindingsTracking
            {
                ...
                public void PropertyChanged_(object sender, global::System.ComponentModel.PropertyChangedEventArgs e)
                {
                    ...
                    if (bindings != null)
                    {
                        ...
                        global::RSSFeedReader.RSSLink obj = sender as global::RSSFeedReader.RSSLink;
                ...
                public void UpdateChildListeners_(global::RSSFeedReader.RSSLink obj)
                {
                    MainPage_obj5_Bindings bindings = TryGetBindingObject();
                    if (bindings != null)
                    {
        ...
        private class MainPage_obj1_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::RSSFeedReader.MainPage dataRoot;
            private bool initialized = false;
            private const int NOT_PHASED = (1 << 31);
            private const int DATA_CHANGED = (1 << 30);
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::RSSFeedReader.MainPage)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            // Update methods for each path node used in binding steps.
            private void Update_(global::RSSFeedReader.MainPage obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
                    {
                        this.Update_RSSLinks(obj.RSSLinks, phase);
                    }
                }
            }
            private void Update_RSSLinks(global::System.Collections.ObjectModel.ObservableCollection<global::RSSFeedReader.RSSLink> obj, int phase)
            {
